...
| **Dodge**    | 1          | Compare Dodge Defense Value (DDV) to AV. If DDV ≥ AV, take 0 damage. If DDV < AV by 5 or less, take **half** damage (Glancing Blow). If AV − DDV > 5, take full damage. |

DVs use the same formula as AV but with Armor Bonuses: `DV = Dice Rolls + Armor Bonus`.
...
Mitigate always subtracts from AV. No threshold — every point of MDV reduces damage.
...
Dodge is a threshold defense with three outcomes:

| Outcome | Condition | Damage |
|---------|-----------|--------|
| Total Success | DDV ≥ AV | 0 |
| Glancing Blow | AV − DDV ≤ 5 | Half (round down) |
| Failure | AV − DDV > 5 | Full |

---

### All-In Defenses

You may sacrifice one defense to supercharge the other. This follows the same rules as Chaining: your secondary defense adds its value to the primary.

**All-In Dodge (sacrifice Mitigate):**
- Cost: Your Mitigate for the round is spent.
- Effect: Add **+5** to your DDV roll.
- Risk: No Mitigate remaining. 

**All-In Mitigate (sacrifice Dodge):**
- Cost: Your Dodge for the round is spent.
- Effect: Add **+3** to your MDV roll.
- Risk: No Dodge remaining. 
...
Armor applies its bonus to both MDV and DDV. Characters start with Basic (+0) and may acquire better armor through play.

---

### Example — Defending
*An Algiere Soldato fires a burst from his SMG at Zoe (Body 5 → 3d6 Mit, Mind 7 → 3d8 Dodge, Basic armor +0).*

**Scenario A — "Take It"**
Zoe has already used Mitigate and Dodge earlier this round. She has no choice but to Take It.
- Soldato rolls AV 16. Zoe Takes It. **16 damage** to her HP.

**Scenario B — Mitigate**
Zoe braces. Armor takes the brunt.
- Soldato rolls AV 16. Zoe Mitigates: rolls 3d6 = `5, 3, 4` = 12. Damage = 16 − 12 = **4 damage**.

**Scenario C — Dodge**
Zoe drops low as the burst tears past.
- Soldato rolls AV 16. Zoe Dodges: rolls 3d8 = `7, 4, 6` = 17. 17 ≥ 16 → **Total Success. 0 damage.**


**Scenario D — Glancing Blow**
- Soldato rolls AV 18. Zoe Dodges: rolls 3d8 = `5, 4, 2` = 11. AV − DDV = 18 − 11 = **7**. 7 > 5 → **Failure. 18 damage.**
- If she'd rolled just 13 (AV−DDV = 5): **Glancing Blow. 9 damage** (half).
...
- Rolls MDV: 3d6 = `6, 4, 3` = 13. Incoming AV is 18. Damage = 18 − 13 = **5 damage**.
